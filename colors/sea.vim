...
hi Normal       guifg=#f0f0f8 guibg=#22224e

" Search
hi IncSearch    gui=UNDERLINE guifg=#ffffff guibg=#c030ff
hi Search       gui=NONE guifg=#f0e0ff guibg=#b020ff

" Messages
hi ErrorMsg     gui=NONE guifg=#ffffff guibg=#ff0000
hi WarningMsg   gui=NONE guifg=#ffffff guibg=#ff0000
hi ModeMsg      gui=NONE guifg=#00e0ff guibg=NONE
hi MoreMsg      gui=NONE guifg=#00ffff guibg=#6060ff
hi Question     gui=NONE guifg=#00f0d0 guibg=NONE
...
hi NonText      gui=NONE guifg=#8080ff guibg=#2c2c78
hi SpecialKey   gui=NONE guifg=#60c0ff guibg=NONE
hi Title        gui=NONE guifg=#f0f0f8 guibg=NONE
hi Visual       gui=NONE guifg=#ffffff guibg=#6060ff
" hi VisualNOS  gui=NONE guifg=#ffffff guibg=#6060ff

" Syntax group
hi Comment      gui=ITALIC guifg=#b0b0c8 guibg=NONE
